# Documento de arquitectura y convenciones — Sistema de Pedidos (caso2)
...
- `src/filtroCliente.js` — filtrado por estado del lado del cliente (ver
  decisión fechada en `docs/specs/spec-historial.md`).
