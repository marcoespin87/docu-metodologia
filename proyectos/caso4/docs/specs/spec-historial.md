...
- Código: `src/historial.py` (implementación viva desde 2026-09-10, filtro
  resuelto en servidor; versión Node archivada en
  `legacy-node/src/historial.js`).
- Tests: `tests/test_historial.py` (caracterización derivada de este spec;
  equivalente a `legacy-node/test/historial.test.js`).
