# Documento de arquitectura y convenciones — Sistema de Pedidos (caso3)
...
- `src/historial.js` — capacidad "historial": listado y filtrado por
  estado (resuelto en el servidor; ver decisión fechada en
